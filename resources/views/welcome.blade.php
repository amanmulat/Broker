                    ...
                    <div class="p-5">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            {{-- <a href="{{route('modalShow' ,[ 'unit' => "1"])}}"> --}}
                                <button href="{{route('unit.show' , '1')}}" data-modal-toggle="extralarge-modal" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"  type="button" >
                                    More
                                ...
                                <button data-modal-toggle="extralarge-modal" 
                                    ...
                                    data-url="{{route('modalShow' ,['unit' =>"1" ] )}}"
                                    >
                                        Submit
                                </button>
                            {{-- </a> --}}
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '#getUser', function(e){
                ...
                .done(function(data , unit  , jqXHR){
                    ...
                    $('#dynamic-content').html(jqXHR.responseText); // load response 
