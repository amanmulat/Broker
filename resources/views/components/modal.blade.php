<div>
    <div id="extralarge-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                    ...
                    <div class="">
                        <div class="grid grid-cols-2 ">
                            ...
                            <div class="col-span-1">
                                ...
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Birr 10,000,000</h5>
