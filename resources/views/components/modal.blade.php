        ...
        <div class="relative p-4 w-full max-w-7xl  h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow min-h-90h dark:bg-gray-700">
                ...
                <div class="grid grid-cols-2 ">
                    <div class="grid grid-cols-2 gap-3 col-span-1 max-h-128 overflow-y-auto mr-2" id="modalImage">
                    </div>
                    <div class="col-span-1">
                        ...
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><span id="sellCurrency"></span>  
                            <span id="sellPrice" class="commas"></span>  
                        </h5>
                        <h5 class=" text-lg font-bold tracking-tight text-gray-900 dark:text-white">Rent</h5>
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><span id="rentCurrency"></span> <span id="rentPrice"></span> / <span id="rentPeriod"></span></h5>
                        <div class="flex">
                        ...
                        <div class="flex">
                            ...
                            <h5 class="mb-2 mr-2  text-base font-bold tracking-tight text-gray-700 dark:text-white"><span id="locationName"></span></h5>
                        </div>
                        ...
                        <div id="tabContentExample">
                            <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="profile-example" role="tabpanel" aria-labelledby="profile-tab-example">
                                <p class="text-sm text-gray-500 dark:text-gray-400" id="desc"></p>
                            </div>
